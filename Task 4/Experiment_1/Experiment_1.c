...
void timer1_init(void)
{
	...
	TCNT1L = 0x6E;	 //Counter lower 8 bit value
	TCCR1B = TCCR1B | 0x05;	 //start Timer by selecting prescalar (avoid overwriting mode selection bits)
}
...
ISR(TIMER1_OVF_vect)
{
	...
	TCNT1L = 0x6E; 	//reload counter low value
...
int main(void)
{
	...
	timer1_init();
	lcd_print(2,1,0,2);   // display initial value of the counter variable by providing appropriate arguments to this function.
